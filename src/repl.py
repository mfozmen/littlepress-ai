...
_AGENT_GREETING_HINT = (
    ...
    "Deterministic ingestion defaults <MIXED>-classified pages to "
    "``text-only`` so the rendered book doesn't print the "
    "handwritten text twice (once baked into the image, once as "
    "page text). The image is still on disk — this command opts "
    "the drawing back in.\n"
